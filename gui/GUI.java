...
public class GUI {
	...
	private void initialize() {
		...
		comboTertiary.setModel(new DefaultComboBoxModel(new String[] {"YELLO", "BLUE", "RED", "GREEN", "CYAN", "BLACK", "WHITE"}));
		Color[] tertiaryColorList = new Color[] {Color.YELLOW, Color.BLUE, Color.RED, Color.GREEN, Color.CYAN, Color.BLACK, Color.WHITE};
		...
		comboQuaternary.setModel(new DefaultComboBoxModel(new String[] {"WHITE", "BLUE", "RED", "GREEN", "CYAN", "BLACK", "YELLOW"}));
