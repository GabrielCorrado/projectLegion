...
public class GUI {
	...
	private void initialize() {
		...
		comboGoalStrategy.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e){
				JComboBox src = (JComboBox) e.getSource();
				AbstractStrategy goalStrategy = goalStrategyList[src.getSelectedIndex()];
		...
		btnUpdatePStrength.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			if(board!=null)
			{
				board.pheromoneStrength = (Integer.parseInt(textField_PheromoneStrength.getText()));
				System.out.println(board.pheromoneStrength);
			}}});
		...
		btnNewBoard.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				tglbtnWrapAgents.setSelected(true);
				board.updateGoalStrategy(goalStrategyList[comboGoalStrategy.getSelectedIndex()]);
