...
public class SwarmAgent extends Ellipse2D.Double {
	 ...
	 */
	public void step(int cellSize){//, int pStrength, int pDirection) {
...
//		Pheromone Directions
		...
		// 0 = No Direction
//		Pheromone Strength
		// larger means stronger pull
		
		
		
		
//		if (pDirection != 9 || pDirection != 0)
//		{
//			if (Math.random() < 0.1) {
...
//			if (Math.random() < pStrength) {
//				this.setVelocity(cellSize*(Math.random()-0.5), cellSize*(Math.random()-0.5));
//			}
//			}//Go up with a % chance equal to the pheromone strength
