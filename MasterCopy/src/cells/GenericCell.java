...
public class GenericCell extends Rectangle2D.Double {
	...
	protected int pheromoneStrength;
	protected int pheromoneDirection = 0;
	...
	public void setPheromoneDirection(int direction)
	{
		this.pheromoneDirection = direction;
	}
	
	public void setPheromoneStrength(int strength)
	{
		this.pheromoneStrength = strength;
	}
